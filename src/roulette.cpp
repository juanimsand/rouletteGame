...
void Roulette::play(int plays)
{
    ...
    { // play sequence for every iteration
        // show play number
...
bool Roulette::addPlayer(std::shared_ptr<RoulettePlayer> &RoulettePlayer)
{
...
{
    std::cout << "Roulette " << id << " will close, please collect your chips.." << std::endl;
    for (int i = 0; i < players.size(); i++)
    {
